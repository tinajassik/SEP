...
/**
 * A class controlling the Manage Booking window.
 *
...
public class ManageBookingController
{
  ...
  /**
   * Initializes the ManageBooking window.
   *
  ...
  /**
   * Resets the ManageBooking window.
   */
  public void reset()
  {
    updateBookings();
  ...
  public void handleActions(ActionEvent e)
  {
    ...
    else if (e.getSource() == buttonCheckOut)
    {
      ...
      {
        if (!((Booking) listView.getSelectionModel()
            .getSelectedItem()).isCheckIn())
        {
          Alert alert = new Alert(Alert.AlertType.WARNING);
  ...
  /**
   * Adds the bookings to the listView.
   */
