...
public class GuestsController
{
  ...
  public void searchGuest(ActionEvent e)
  {
    ...
    if (e.getSource() == searchButton)
    {
      ...
      for (int i = 0; i < guests.size(); i++)
      {
        if (guests.getGuest(i).getFirstName().equals(firstName)
            && guests.getGuest(i).getLastName().equals(lastName))
        {
      ...
      for (int j = 0;
           j < bookings.getBookingsByFullName(firstName, lastName).size(); j++)
      {
  ...
  {
    GuestList guests = modelManager.getAllGuests();
    String guest = (String) guestsListView.getSelectionModel()
        .getSelectedItem();
    for (int i = 0; i < guests.size(); i++)
    {
      String s = guests.getGuest(i).getFirstName() + " " + guests.getGuest(i)
          .getLastName();
