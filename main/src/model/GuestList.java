...
public class GuestList implements Serializable
{
   ...
   *
   * @return a String containing information about all the Guest objects in the list - each Guest starting with "Guest: " and followed by a new line character
   */
   ...
   * @return true if given list contains objects that are equal to this list else false
   */
